...
function catAndMouse(x, y, z) {
	...
	console.log(catAPosition, catBPosition);
	if (catAPosition > catBPosition) return 'Cat B';

	if (catBPosition > catAPosition) return 'Cat A';

	if (catAPosition === catBPosition) return 'Mouse C';
}
